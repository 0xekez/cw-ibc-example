...
require (
	github.com/CosmWasm/wasmd v0.31.0-rc1
...
replace (
	// <https://github.com/CosmWasm/wasmd/pull/1248>
	github.com/CosmWasm/wasmd => github.com/0xekez/wasmd v0.0.0-20230309011806-b64fa078a327
